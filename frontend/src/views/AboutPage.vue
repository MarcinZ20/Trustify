...
<template>
  <div class="bg-white py-24 sm:py-32 m-2 rounded-lg">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <h2 class="text-base/7 font-semibold text-indigo-600">Reliable source</h2>
        <p
          class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance"
        >
          Everything you need to access reliable news
        </p>
        <p class="mt-6 text-lg/8 text-gray-600">
          Trustify provides you with a modern and functional interface to help you verify
          information. We believe that everyone has the right to know. Including you.
        </p>
      </div>
